...
@article{rahimi2026solidualsphysics,
  title   = {SoliDualSPHysics: An extension of DualSPHysics to solid mechanics
...
| **Solid mechanics core** (`JSphDeformStruc`, material models, fracture) | GNU GPL v3 | © 2024 Dr. Naqib Rahimi & Dr. Georgios Moutsanidis |
| **Expression parser and utilities** (`JUserExpression`, XML readers) | GNU LGPL v2.1+ | © 2024 Dr. Naqib Rahimi & Dr. Georgios Moutsanidis |
...
This work was developed as part of Dr. Naqib Rahimi's PhD thesis under the supervision of Dr. Georgios Moutsanidis at Stony Brook University. We gratefully acknowledge the DualSPHysics development team for providing the SPH framework upon which SoliDualSPHysics is built.
