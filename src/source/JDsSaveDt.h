...
private:
  ...
  StValue Dt3[SizeValues];              ///<Dt3 [SizeValues].               //<vs_deformstruc>
  StValue AceMax[SizeValues];           ///<AceMax [SizeValues].
  StValue ViscDtMax[SizeValues];        ///<ViscDtMax [SizeValues].
  StValue DeformStrucDtMax[SizeValues];   ///<DeformStrucDtMax [SizeValues].    //<vs_deformstruc>
  ...
  StValue LastDt3;            //<vs_deformstruc>
  StValue LastAceMax,LastViscDtMax,LastVelMax;
  StValue LastDeformStrucDtMax; //<vs_deformstruc>
...
public:
  ...
  void AddValues(double timestep,double dtfinal,double dt1,double dt2,double dt3,double acemax,double viscdtmax,double deformstrucdtmax,double velmax);
