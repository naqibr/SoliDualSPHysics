...
protected:
	...
	JCellDivGpuSingle* DSCellDivSingle;
	...
	void DSPerformCellDiv(StDeformStrucData* defstrucdatac);
	void DSSaveInitDomainInfo(StDeformStrucData* defstrucdatac)const;
	void DSSetBoundCond(StDeformStrucData* defstrucdatac) const;
