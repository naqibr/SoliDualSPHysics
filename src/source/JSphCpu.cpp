...
void JSphCpu::InitVars() {
	...
	DSPhiDDot = NULL; DSHis = NULL; DSCorrArray = NULL; DSJacob = NULL; DSEqPlastic = NULL; DSPlasticStrain = NULL; DSPlasticFp = NULL; DSParent = NULL;
	DSiBodyRidp = NULL;
...
void JSphCpu::FreeCpuMemoryFixed() {
	...
	delete[]DSPlasticFp; DSPlasticFp = NULL;
...
void JSphCpu::DSAllocCpuMemoryFixed() {
	...
	if (MapNdeformstruc) {
		...
		if (DSPlastic) {
			...
			DSPlasticFp = new tmatrix3d[MapNdeformstruc]; MemCpuFixed += (sizeof(tmatrix3d) * MapNdeformstruc);
			std::fill(DSPlasticFp, DSPlasticFp + MapNdeformstruc, TMatrix3d(0.0));
		}
		if (DSFracture) {
