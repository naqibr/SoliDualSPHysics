...
void SortDataParticles(unsigned np,unsigned pini,const unsigned* sortpart, const unsigned* a1, const typecode* b1, const unsigned* c1, const float4* d1, unsigned* a2, typecode* b2, unsigned* c2, float4* d2);
...
void UpdateIndices(unsigned n,const unsigned *sortidx,unsigned *idx);           //<vs_deformstruc>
