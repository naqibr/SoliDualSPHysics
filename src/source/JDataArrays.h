...
public:
	...
	unsigned AddArray(std::string fullname, unsigned count, const tfloat4* ptr, bool delptr = false) { return(AddArray(fullname, TypeFloat4, count, (void*)ptr, delptr)); }
	...
	unsigned AddArray(std::string fullname, unsigned count, const tmatrix3d* ptr, bool delptr = false) { return(AddArray(fullname, TypeMatrix3d, count, (void*)ptr, delptr)); }
	unsigned AddArray(std::string fullname, unsigned count, const tmatrix3f* ptr, bool delptr = false) { return(AddArray(fullname, TypeMatrix3f, count, (void*)ptr, delptr)); }
	...
	const tfloat4*  GetArrayFloat4  (const std::string& keyname, unsigned count = 0)const { return((tfloat4*)   GetArrayPtr(keyname, TypeFloat4, count)); }
	...
	const tmatrix3d* GetArrayMatrix3d(const std::string& keyname, unsigned count = 0)const { return((tmatrix3d*) GetArrayPtr(keyname, TypeMatrix3d, count)); }
	const tmatrix3f* GetArrayMatrix3f(const std::string& keyname, unsigned count = 0)const { return((tmatrix3f*)GetArrayPtr(keyname, TypeMatrix3f, count)); }
	const tsymatrix3f* GetArraySymMatrix3f(const std::string& keyname, unsigned count = 0)const { return((tsymatrix3f*)GetArrayPtr(keyname, TypeSyMatrix3f, count)); }
