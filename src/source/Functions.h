...
#define NAQIB_PAUSE_HERE do { \
    std::cout << "\n ---> Function: " << __func__ << ", File: " << __FILE__ << ", Line: " << __LINE__ << std::endl; \
    system("pause"); \
} while(0)

#define NAQIB_IS_HERE \
    std::cout <<"\n ---> "<<"Function: " << __func__ << ", File: " << __FILE__ << ", Line: " << __LINE__ << std::endl;
#define NAQIB_PRINT_VAR(data) \
    std::cout << #data<<" = " <<data<< std::endl;

#define NAQIB_PRINT_MAT(matrix) do { \
    std::cout << #matrix << ":\n"; \
    std::cout << matrix.a11 << " " << matrix.a12 << " " << matrix.a13 << std::endl; \
    std::cout << matrix.a21 << " " << matrix.a22 << " " << matrix.a23 << std::endl; \
    std::cout << matrix.a31 << " " << matrix.a32 << " " << matrix.a33 << std::endl; \
} while(0)

#define NAQIB_PRINT_VEC(vec) do { \
