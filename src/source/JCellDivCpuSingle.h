...
protected:
  ...
  void DSPreSort(const unsigned* dcellc);
  void DSPrepareNct();
  void DSPreSortFull(unsigned np, const unsigned* dcellc, unsigned* cellpart, unsigned* partsincell)const;
  void DSCalcCellDomain();
public:
  ...
  void DSDivide(unsigned np, const unsigned* dcellc, const typecode* codec, JDsTimersCpu* timersc);
