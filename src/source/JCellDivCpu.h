...
protected:
  ...
  void SortIndices(unsigned *sortpart,unsigned* sortidx,unsigned np,bool stable); //<vs_deformstruc>
  void UpdateIndices(unsigned np,const unsigned *sortidx,unsigned *idx);          //<vs_deformstruc>
