...
class JPartDataBi4 : protected JObject
{
 ...
 private:
  ...
  void AddPartData(unsigned npok,const unsigned *idp,const ullong *idpd,const tfloat3 *pos,const tdouble3 *posd,const tfloat3 *vel,const float *rhop, const float* pressp, bool externalpointer=true);
 ...
 public:
  ...
  void AddPartData(unsigned npok,const unsigned *idp, const tfloat3  *pos, const tfloat3 *vel,const float *rhop, const float* pressp,bool externalpointer=true){  AddPartData(npok,idp ,NULL,pos ,NULL,vel, rhop, pressp,externalpointer);  }
  void AddPartData(unsigned npok,const unsigned *idp, const tdouble3 *posd,const tfloat3 *vel,const float *rhop, const float* pressp, bool externalpointer=true){  AddPartData(npok,idp ,NULL,NULL,posd,vel, rhop, pressp,externalpointer);  }
  void AddPartData(unsigned npok,const ullong   *idpd,const tfloat3  *pos, const tfloat3 *vel,const float *rhop, const float* pressp,bool externalpointer=true){  AddPartData(npok,NULL,idpd,pos ,NULL,vel, rhop, pressp,externalpointer);  }
  void AddPartData(unsigned npok,const ullong   *idpd,const tdouble3 *posd,const tfloat3 *vel,const float *rhop, const float* pressp,bool externalpointer=true){  AddPartData(npok,NULL,idpd,NULL,posd,vel, rhop, pressp,externalpointer);  }
