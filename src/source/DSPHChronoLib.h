...
//:# - Elementos deformables con formas circulares 2D (v4.02 / 14-07-2020)
//:# - Elementos deformables con formas rectangulares 2D (v4.03 / 28-09-2020)
//:# - Permite la simulacion de ChLinks con coeficientes variables de stiffness 
//:#   y damping. (v4.04 / 04-10-2020)
//:# - Activadas las colisiones entre objetos deformables y objetos rigidos usando
...
//:# - Permite seleccionar el modo de colision de los objetos deformables (v4.07 / 06-11-2020) 
