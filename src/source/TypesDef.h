...
inline tfloat3 operator  +(const tuint3& a, const float& b) { return(TFloat3(a.x + b, a.y + b, a.z + b)); }
inline tfloat3 operator  -(const tuint3& a, const float& b) { return(TFloat3(a.x - b, a.y - b, a.z - b)); }
inline tfloat3 operator  *(const tuint3& a, const float& b) { return(TFloat3(a.x * b, a.y * b, a.z * b)); }
inline tfloat3 operator  /(const tuint3& a, const float& b) { return(TFloat3(a.x / b, a.y / b, a.z / b)); }

inline tfloat3 operator +(const float& b, const tuint3& a) { return(TFloat3(a.x + b, a.y + b, a.z + b)); }
inline tfloat3 operator -(const float& b, const tuint3& a) { return(TFloat3(b - a.x, b - a.y, b - a.z)); }
inline tfloat3 operator *(const float& b, const tuint3& a) { return(TFloat3(a.x * b, a.y * b, a.z * b)); }
inline tfloat3 operator /(const float& b, const tuint3& a) { return(TFloat3(b / a.x, b / a.y, b / a.z)); }

inline tfloat3 operator +(const float& b, const tfloat3& a) { return(TFloat3(a.x + b, a.y + b, a.z + b)); }
inline tfloat3 operator -(const float& b, const tfloat3& a) { return(TFloat3(b - a.x, b - a.y, b - a.z)); }
inline tfloat3 operator *(const float& b, const tfloat3& a) { return(TFloat3(a.x * b, a.y * b, a.z * b)); }
inline tfloat3 operator /(const float& b, const tfloat3& a) { return(TFloat3(b / a.x, b / a.y, b / a.z)); }


inline tfloat3& operator +=(tfloat3& a, const tfloat3& b) { a.x += b.x; a.y += b.y; a.z += b.z; return a; }
inline tfloat3& operator -=(tfloat3& a, const tfloat3& b) { a.x -= b.x; a.y -= b.y; a.z -= b.z; return a; }
inline tfloat3& operator *=(tfloat3& a, const tfloat3& b) { a.x *= b.x; a.y *= b.y; a.z *= b.z; return a; }
inline tfloat3& operator /=(tfloat3& a, const tfloat3& b) { a.x /= b.x; a.y /= b.y; a.z /= b.z; return a; }
...
inline bool operator ==(const tfloat3& a, const tdouble3& b) { return(a.x == b.x && a.y == b.y && a.z == b.z); }
inline bool operator !=(const tfloat3& a, const tdouble3& b) { return(a.x != b.x || a.y != b.y || a.z != b.z); }
inline bool operator <(const tfloat3& a, const tdouble3& b) { return(a.x < b.x && a.y < b.y && a.z < b.z); }
inline bool operator >(const tfloat3& a, const tdouble3& b) { return(a.x > b.x && a.y > b.y && a.z > b.z); }
inline bool operator <=(const tfloat3& a, const tdouble3& b) { return(a.x <= b.x && a.y <= b.y && a.z <= b.z); }
...
inline tdouble3 operator +(const double& b, const tdouble3& a) { return(TDouble3(a.x + b, a.y + b, a.z + b)); }
inline tdouble3 operator -(const double& b, const tdouble3& a) { return(TDouble3(b - a.x, b - a.y, b - a.z)); }
inline tdouble3 operator *(const double& b, const tdouble3& a) { return(TDouble3(a.x * b, a.y * b, a.z * b)); }
inline tdouble3 operator /(const double& b, const tdouble3& a) { return(TDouble3(b/a.x, b/a.y, b/a.z)); }
inline tdouble3& operator +=(tdouble3& a, const tdouble3& b) { a.x += b.x; a.y += b.y; a.z += b.z; return a; }
inline tdouble3& operator -=(tdouble3& a, const tdouble3& b) { a.x -= b.x; a.y -= b.y; a.z -= b.z; return a; }
inline tdouble3& operator *=(tdouble3& a, const tdouble3& b) { a.x *= b.x; a.y *= b.y; a.z *= b.z; return a; }
inline tdouble3& operator /=(tdouble3& a, const tdouble3& b) { a.x /= b.x; a.y /= b.y; a.z /= b.z; return a; }

inline tdouble3& operator +=(tdouble3& a, const double b) { a.x += b; a.y += b; a.z += b; return a; }
inline tdouble3& operator -=(tdouble3& a, const double b) { a.x -= b; a.y -= b; a.z -= b; return a; }
inline tdouble3& operator *=(tdouble3& a, const double b) { a.x *= b; a.y *= b; a.z *= b; return a; }
inline tdouble3& operator /=(tdouble3& a, const double b) { a.x /= b; a.y /= b; a.z /= b; return a; }
...
{
    tmatrix3f m = { a.a11 + b.a11, a.a12 + b.a12, a.a13 + b.a13 ,
...
inline tmatrix3f operator + (const float a, const tmatrix3f& b)
{
    tmatrix3f m = { a + b.a11, a + b.a12, a + b.a13 ,
                     a + b.a21, a + b.a22, a + b.a23 ,
                     a + b.a31, a + b.a32, a + b.a33 };
    return m;
}
inline tmatrix3f operator + (const tmatrix3f& b, const float a)
{
    tmatrix3f m = { a + b.a11, a + b.a12, a + b.a13 ,
                     a + b.a21, a + b.a22, a + b.a23 ,
                     a + b.a31, a + b.a32, a + b.a33 };
...
{
    tmatrix3f m = { a.a11 - b, a.a12 - b, a.a13 - b,
...
inline tmatrix3f& operator +=(tmatrix3f& a, const tmatrix3f& b) {
    a.a11 += b.a11; a.a12 += b.a12; a.a13 += b.a13;
    a.a21 += b.a21; a.a22 += b.a22; a.a23 += b.a23;
    a.a31 += b.a31; a.a32 += b.a32; a.a33 += b.a33;
    return a;
}
inline tmatrix3f& operator +=(tmatrix3f& a, const float b) {
    a.a11 += b; a.a12 += b; a.a13 += b;
    a.a21 += b; a.a22 += b; a.a23 += b;
    a.a31 += b; a.a32 += b; a.a33 += b;
    return a;
}
...
{
    tmatrix3d m = { a.a11 + b.a11, a.a12 + b.a12, a.a13 + b.a13 ,
                     a.a21 + b.a21, a.a22 + b.a22, a.a23 + b.a23 ,
                     a.a31 + b.a31, a.a32 + b.a32, a.a33 + b.a33 };
    return m;
}
...
inline tmatrix3d operator + (const double a, const tmatrix3d& b)
{
    tmatrix3d m = { a + b.a11, a + b.a12, a + b.a13 ,
                     a + b.a21, a + b.a22, a + b.a23 ,
                     a + b.a31, a + b.a32, a + b.a33 };
    return m;
}
inline tmatrix3d operator + (const tmatrix3d& b, const double a)
{
    tmatrix3d m = { a + b.a11, a + b.a12, a + b.a13 ,
                     a + b.a21, a + b.a22, a + b.a23 ,
                     a + b.a31, a + b.a32, a + b.a33 };
...
inline tmatrix3d operator - (const tmatrix3d& a, const double b)
{
    tmatrix3d m = { a.a11 - b, a.a12 - b, a.a13 - b,
                     a.a21 - b, a.a22 - b, a.a23 - b,
                     a.a31 - b, a.a32 - b, a.a33 - b };
    return m;
}
...
inline tmatrix3d& operator +=(tmatrix3d& a, const tmatrix3d& b) {
    a.a11 += b.a11; a.a12 += b.a12; a.a13 += b.a13;
    a.a21 += b.a21; a.a22 += b.a22; a.a23 += b.a23;
    a.a31 += b.a31; a.a32 += b.a32; a.a33 += b.a33;
    return a;
...
///Boundary condition definition for structures using double values.
//typedef struct {
//    double x, y, z;
//    //word mkid;
//    //word mkcode;
//    uint64_t flags;
//}tbcstruc;
//inline tbcstruc TBCStrucNull() { tbcstruc p = { 0.0, 0.0, 0.0, 0,0, 0}; return p; }

///Cell structure for contact of deformable structures
typedef struct {
    std::vector<unsigned> pids;
}tdefstruccell;

///4 Noded plane definition for structures using double values.
typedef struct {
    tdouble3 corners[4];
}plane4Nstruc;
inline plane4Nstruc TNotchStrucNull() { plane4Nstruc p; for (unsigned i = 0; i < 4; i++) p.corners[i] = { 0.0,0.0,0.0 }; return p; }

///Boundary condition definition for structur particles using double values.
typedef struct {
    float x, y, z, tst, tend;
    uint64_t flags;
    word mkid;
    word mkcode;
}tbcstrucbody;
inline tbcstrucbody make_tbcstrucbody0() { tbcstrucbody p; p.mkcode = p.mkid = 0; p.x = p.y = p.z = p.tst = p.tend = 0.0f; p.flags = 0; return p;}

typedef struct {
    float x, y, z, tst, tend;
    uint64_t flags;
}tbcstruc;
inline tbcstruc make_bcstruc0() { tbcstruc p; p.x = p.y = p.z = p.tst = p.tend = 0.0f; p.flags = 0; return p; }

///Compact phi boundary condition structure (8 bytes: only expression ID and flags).
typedef struct {
    unsigned exprid;  ///< Expression ID that returns 0-1 for phi restore value.
    unsigned flags;   ///< Flags: bit 0 = active.
}tphibc;
inline tphibc make_tphibc0() { tphibc p; p.exprid = 0; p.flags = 0; return p; }

typedef struct {
    word mkcode;
    std::vector<tdouble3> pts;

    tdouble3 planeOrigin;
    tdouble3 planeNormal;

    tdouble3 axis1, axis2;

    std::vector<tdouble2> polygon;
} tbcregion;

struct tuserexpressiondata {
    unsigned id;
...
typedef enum{ 
  ...
  ,TypeSyMatrix3f=100
    //-DimOfType() -> 9
  ,TypeMatrix3d = 101, TypeMatrix3f = 102
}TpTypeData; 
